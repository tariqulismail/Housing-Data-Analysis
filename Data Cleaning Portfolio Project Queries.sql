...
select * from NASHVILLE_HOUSING a Where a.PropertyAddress is null;
select * from NASHVILLE_HOUSING a where a.ParcelID  = '025 07 0 031.00';

update NASHVILLE_HOUSING t set t.PropertyAddress = (select nvl(t.PropertyAddress,u.PropertyAddress) from NASHVILLE_HOUSING u 
...
delete  from NASHVILLE_HOUSING t
